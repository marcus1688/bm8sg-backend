...
router.post("/api/ibex/syncGameStatus", async (req, res) => {
  try {
    const { currency = "SGD", status = 1 } = req.body;
...
router.post("/api/ibex/getprovidergamelist", async (req, res) => {
  try {
    const { gameLang, currency = "SGD", status = 1 } = req.body;
...
router.post("/api/ibex/verifysessionsg", async (req, res) => {
  try {
...
router.post("/api/ibex/getbalancesg", async (req, res) => {
  try {
...
router.post("/api/ibex/betpayoutsg", async (req, res) => {
  try {
    const {
      operator_token,
      secret_key,
...
router.post("/api/ibex/balanceadjustmentsg", async (req, res) => {
  try {
    const {
      operator_token,
      secret_key,
