...
router.post("/api/telegram-login", loginLimiter, async (req, res) => {
  ...
  try {
    const BOT_TOKENS = {
      7674849683: process.env.TELEGRAM_BOT_TOKEN_VIP,
      8397825813: process.env.TELEGRAM_BOT_TOKEN_COM,
    };
