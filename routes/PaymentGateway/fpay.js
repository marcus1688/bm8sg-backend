...
const merchantNameOnlineBanking = "BM8sgd_inf";
...
const bankIDPG = "6929c7724d6d42211caf1cf4";
...
async function getFPayAuth() {
  try {
    const payload = {
      username: merchantNameOnlineBanking,
      api_key: fpayBankAPIKEY,
    };
...
router.post("/api/fpaysg", async (req, res) => {
  try {
